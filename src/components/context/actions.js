import { TYPE_SETPROFILE, VALUE_FALSE, VALUE_TRUE,
  TYPE_CLOSELOGIN, TYPE_OPENLOGIN, TYPE_OPENSIGNIN,
  TYPE_EDITARTICLE, TYPE_OPENARTICLE } from "./constants";
// Type constanst
...
export const ACTION_OPENARTICLE = (article) => { return { type: TYPE_OPENARTICLE, value: article } };
